...
public class AdptSpPriceList extends RecyclerView.Adapter<AdptSpPriceList.PriceViewHolder> {
    Context context;
    private RecyclerClickListener clickListener;
    ArrayList<ModelPriceListData> priceListData;
    public AdptSpPriceList(Context context,ArrayList<ModelPriceListData> priceListData){
